      ...
      {tokenData ? (
        !tokenData.exists ? (
          <LightGreyCard style={{ textAlign: 'center' }}>
            ...
            <StyledExternalLink style={{ marginLeft: '4px' }} href={`https://app.carthagedex.org/#/add/${address}`}>
              here.
            </StyledExternalLink>
          </LightGreyCard>
        ) : (
          <AutoColumn gap="32px">
            <AutoColumn gap="32px">
              ...
              <ResponsiveRow align="flex-end">
                ...
                {activeNetwork !== EthereumNetworkInfo ? null : (
                  <RowFixed>
                    <StyledExternalLink href={`https://app.carthagedex.org/#/add/${address}`}>
                    ...
                    <StyledExternalLink href={`https://app.carthagedex.org/#/swap?inputCurrency=${address}`}>
